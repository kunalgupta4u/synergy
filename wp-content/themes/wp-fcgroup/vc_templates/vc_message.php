 ...
 */
$el_class = $message_box_color = $message_box_style = $style = $css = $color = $css_animation = $icon_type = $message_closeable = $remove_icon_message = '';
...
$remove_icon_message = ($remove_icon_message && $remove_icon_message == 'true')?' remove-icon':'';
?>
<div class="<?php echo esc_attr( $css_class ); ?> <?php echo esc_attr( $remove_icon_message ); ?> ">
	<?php if ($message_closeable && $message_closeable == 'yes') :  ?>
		<button aria-hidden="true" data-dismiss="alert" class="close" type="button">&times;</button>
	<?php endif; ?>
	<div class="vc_message_box-icon"><i class="<?php echo esc_attr( $iconClass ); ?> cms-icon "></i></div>
